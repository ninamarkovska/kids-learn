...
final _categories = ['сите', 'цвет', 'овошје', 'зеленчук', 'дрво', 'посебно'];
  ...
  List<PlantModel> get _filtered {
    ...
    return PlantsData.plants.where((p) => p.category == _selectedCategory).toList();
  }
        ...
        itemBuilder: (_, i) {
          ...
          return Padding(
            ...
            child: GestureDetector(
              onTap: () => setState(() { _selectedCategory = cat; _selected = null; }),
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [BoxShadow(color: const Color(0xFF11998e).withOpacity(0.15), blurRadius: 6)]),
  ...
  switch (cat) {
    ...
    case 'цвет':     return '🌸 Цветови';
    case 'овошје':   return '🍎 Овошје';
    case 'зеленчук': return '🥦 Зеленчук';
    case 'дрво':     return '🌳 Дрвја';
    case 'посебно':  return '🌵 Посебни';
    default:         return cat;
  }
}
    ...
    return AnimatedContainer(
      ...
      child: Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Text(p.funFact, style: const TextStyle(fontSize: 12, color: Colors.white70)),
        ])),
      ]),
    );
  }
  ...
  Widget _buildGrid() {
    return GridView.builder(
      ...
      itemBuilder: (_, i) => PlantCard(
        plant: _filtered[i], index: i, onTap: () => _onTap(_filtered[i])),
    );
  }
}